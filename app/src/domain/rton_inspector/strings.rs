...
pub(crate) fn inspect_rton_string_info(
    bytes: &impl ByteRead,
    offset: usize,
...
pub(crate) fn maybe_collect_string_tables(
    bytes: &impl ByteRead,
    target_offset: usize,
...
pub(crate) fn inspect_ascii_run(bytes: &impl ByteRead, offset: usize) -> Option<RtonAsciiRun> {
